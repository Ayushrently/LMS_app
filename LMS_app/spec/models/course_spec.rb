...
RSpec.describe Course, type: :model do
  ...
  describe ".active" do
    it "returns courses without deleted_at" do
      ...
      expect(described_class.active.where(id: [active_course.id, soft_deleted_course.id]))
        .to contain_exactly(active_course)
    end
  end
  ...
  describe ".soft_deleted" do
    it "returns courses with deleted_at set" do
      ...
      expect(described_class.soft_deleted.where(id: [soft_deleted_course.id, active_course.id]))
  ...
  describe "#soft_delete!" do
    ...
    it "soft deletes the course and removes author enrollments when enrollments exist" do
      ...
      create(:enrollment, course: course_with_author)

      expect { course_with_author.soft_delete! }
