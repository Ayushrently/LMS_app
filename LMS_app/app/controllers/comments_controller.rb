...
class CommentsController < ApplicationController
  before_action :set_commentable, except: %i[edit update destroy]
  ...
  def update
    if @comment.update(comment_params)
      if @comment.commentable_type == 'Lesson'
        redirect_to course_lesson_path(@comment.commentable.course, @comment.commentable, anchor: 'comments-section'),
                    notice: 'Comment updated successfully.'
      else
        redirect_to course_path(@comment.commentable, anchor: 'comments-section'),
                    notice: 'Comment updated successfully.'
      end
    else
      render :edit
